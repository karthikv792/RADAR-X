(define
	...
	(:predicates
		...
		( EXPLAINED_DEPLOY_SMALL_ENGINES_FIRECHIEF_ADMINFIRE_BYENG_1 )
		...
		( NOT_EXPLAINED_DEPLOY_SMALL_ENGINES_FIRECHIEF_ADMINFIRE_BYENG_1 )
		( NOT_EXPLAINED_DEPLOY_BIG_ENGINES_FIRECHIEF_MESAFIRE_BYENG_1 )
		( NOT_EXPLAINED_SEND_SOCIAL_MEDIA_BYENG_BYENG_1 )
		( NOT_EXPLAINED_ADDRESS_MEDIA_FIRECHIEF_1 )
		( EXPLAINED_FULL_OBS_SEQUENCE )
		( NOT_EXPLAINED_FULL_OBS_SEQUENCE )
	) 
	(:functions (total-cost))
	(:action EXPLAIN_OBS_DEPLOY_SMALL_ENGINES_FIRECHIEF_ADMINFIRE_BYENG_1
		:parameters ()
		:precondition
		(and
			( HAS_SMALL_ENGINES_NUMBER_ADMINFIRE )
		...
		(and
			...
			(not ( ALERTED_ADMINFIRE ))
			 (not ( NOT_EXPLAINED_DEPLOY_SMALL_ENGINES_FIRECHIEF_ADMINFIRE_BYENG_1 ))
		)
	)
	...
	(:action EXPLAIN_OBS_SEND_SOCIAL_MEDIA_BYENG_BYENG_1
		:parameters ()
		:precondition
		(and
			( NEEDED_ADDRESS_MEDIA )
		...
		(and
			...
			(not ( NO_SOCIAL_MEDIA ))
			 (not ( NOT_EXPLAINED_SEND_SOCIAL_MEDIA_BYENG_BYENG_1 ))
		)
	)
