...
class Problem:
	...
	tr_domain = '../../mmp_foil_explanations/src/tr-domain.pddl'
    ...
    def isGoal(self, state):
        ...
        # Todo: Run pr2plan to get compiled model for partial foil
        # Run get_plan function here
...
def main():
    ...
    parser.add_argument('-pf', '--partialfoil', type=str, help="Partial Foil.")
